...
public class FormRequest extends Request<String> {
    ...
    private Map<String, String> params; // 需要提交的参数

    public FormRequest(String url, Map<String, String> params, SuccessListener listener, Response.ErrorListener errorListener) {
    ...
    public FormRequest(String url, Map<String, String> params, String charSet, SuccessListener listener, Response.ErrorListener errorListener) {
